...
public partial class AbiEncoder
{
    ...
    IArrayAbiEncoder IArrayAbiEncoder.Int8Array(params sbyte[] value)
        => Int8Array(value);
    IStructAbiEncoder IStructAbiEncoder.Int8Array(params sbyte[] value)
        => Int8Array(value);
    ...
    IArrayAbiEncoder IArrayAbiEncoder.UInt8Array(params byte[] value)
        => UInt8Array(value);
    IStructAbiEncoder IStructAbiEncoder.UInt8Array(params byte[] value)
        => UInt8Array(value);
    ...
    IArrayAbiEncoder IArrayAbiEncoder.Int16Array(params short[] value)
        => Int16Array(value);
    IStructAbiEncoder IStructAbiEncoder.Int16Array(params short[] value)
        => Int16Array(value);
    ...
    IArrayAbiEncoder IArrayAbiEncoder.UInt16Array(params ushort[] value)
        => UInt16Array(value);
    IStructAbiEncoder IStructAbiEncoder.UInt16Array(params ushort[] value)
        => UInt16Array(value);
