...
public readonly partial struct UInt256 : ISpanFormattable, IUtf8SpanFormattable
{
    /// <summary>
    ...
    /// formats represent the unsigned value without an extra sign digit or a prefix.
    /// Precision specifies a minimum digit count, padded with zeros.
    ...
    public string ToString(string? format, IFormatProvider? provider)
        => IntegerFormatter.Format(in this, false, format, provider);
    ...
    ) => IntegerFormatter.TryFormat(in this, false, destination, out charsWritten, format, provider);
    ...
    ) => IntegerFormatter.TryFormat(in this, false, utf8Destination, out bytesWritten, format, provider);
}
