...
public readonly struct Int256 : IEquatable<Int256>, IComparable, IComparable<Int256>, IConvertible
{
    ...
    public Int256(BigInteger big)
    {
        if(big.Sign < 0)
        {
            new Int256((UInt256) (-big)).Neg(out var neg);
            _value = neg._value;
        }
        else
        {
    ...
    {
        bool overflow = UInt256.AddOverflow(a._value, b._value, out var ures);
        res = new Int256(ures);
        return overflow;
    }
    ...
    {
        UInt256.AddOverflow(a._value, b._value, out var ures);
        res = new Int256(ures);
    }
    ...
    {
        a._value.Subtract(b._value, out var ures);
        res = new Int256(ures);
    }
    ...
    public static void Exp(in Int256 b, in Int256 e, out Int256 res)
    {
        ...
        {
            b.Neg(out var neg);
            UInt256.Exp(neg._value, e._value, out var ures);
            if(!e._value.Bit(0))
            {
                res = new Int256(ures);
            }
        ...
        {
            UInt256.Exp(b._value, e._value, out var ures);
            res = new Int256(ures);
        }
    }
    ...
    {
        x._value.LeftShift(n, out var ures);
        res = new Int256(ures);
    }
    ...
    private void Srsh64(out Int256 res) => res = new Int256(new UInt256(_value.u1, _value.u2, _value.u3, UInt64.MaxValue));

    private void Srsh128(out Int256 res) => res = new Int256(new UInt256(_value.u2, _value.u3, UInt64.MaxValue, UInt64.MaxValue));

    private void Srsh192(out Int256 res) => res = new Int256(new UInt256(_value.u3, UInt64.MaxValue, UInt64.MaxValue, UInt64.MaxValue));
    ...
    private static void Rsh(in Int256 x, int n, out Int256 res)
    {
        if(x.Sign >= 0)
        {
            x._value.RightShift(n, out var ures);
            res = new Int256(ures);
            return;
        }
        if(n % 64 == 0)
    ...
    public static explicit operator BigInteger(Int256 x)
    {
        ...
        BinaryPrimitives.WriteUInt64LittleEndian(bytes[..8], x._value.u0);
