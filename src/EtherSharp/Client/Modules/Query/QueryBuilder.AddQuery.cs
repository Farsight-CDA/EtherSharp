...
internal partial class QueryBuilder<TQuery> : IQueryBuilder<TQuery>
{
    ...
    public IQueryBuilder<TQuery> AddQuery<T1>(IQuery<T1> c1, Func<T1, TQuery> mapping)
    {
        int resultIndex = _queries.Count;

        int o1 = _queries.Count - resultIndex;
        _queries.AddRange(c1.GetQueries());
        _resultSelectorFunctions.Add((resultIndex, x => mapping(c1.ReadResultFrom(x[o1..]))));
        return this;
    }

    public IQueryBuilder<TQuery> AddQuery<T1, T2>(IQuery<T1> c1, IQuery<T2> c2, Func<T1, T2, TQuery> mapping)
    {
        int resultIndex = _queries.Count;
        ...
        _queries.AddRange(c2.GetQueries());
        _resultSelectorFunctions.Add((resultIndex, x => mapping(c1.ReadResultFrom(x[o1..]), c2.ReadResultFrom(x[o2..]))));
        return this;
    }

    public IQueryBuilder<TQuery> AddQuery<T1, T2, T3>(IQuery<T1> c1, IQuery<T2> c2, IQuery<T3> c3, Func<T1, T2, T3, TQuery> mapping)
    {
        int resultIndex = _queries.Count;
        ...
        _queries.AddRange(c3.GetQueries());
        _resultSelectorFunctions.Add((resultIndex, x => mapping(c1.ReadResultFrom(x[o1..]), c2.ReadResultFrom(x[o2..]), c3.ReadResultFrom(x[o3..]))));
        return this;
    }

    public IQueryBuilder<TQuery> AddQuery<T1, T2, T3, T4>(IQuery<T1> c1, IQuery<T2> c2, IQuery<T3> c3, IQuery<T4> c4, Func<T1, T2, T3, T4, TQuery> mapping)
    {
        int resultIndex = _queries.Count;
        ...
        _queries.AddRange(c4.GetQueries());
    ...
    public IQueryBuilder<TQuery> AddQuery<T1, T2, T3, T4, T5>(IQuery<T1> c1, IQuery<T2> c2, IQuery<T3> c3, IQuery<T4> c4, IQuery<T5> c5, Func<T1, T2, T3, T4, T5, TQuery> mapping)
    {
        int resultIndex = _queries.Count;
        ...
        _queries.AddRange(c5.GetQueries());
    ...
    public IQueryBuilder<TQuery> AddQuery<T1, T2, T3, T4, T5, T6>(IQuery<T1> c1, IQuery<T2> c2, IQuery<T3> c3, IQuery<T4> c4, IQuery<T5> c5, IQuery<T6> c6, Func<T1, T2, T3, T4, T5, T6, TQuery> mapping)
    {
        int resultIndex = _queries.Count;
        ...
        _queries.AddRange(c6.GetQueries());
    ...
    public IQueryBuilder<TQuery> AddQuery<T1, T2, T3, T4, T5, T6, T7>(IQuery<T1> c1, IQuery<T2> c2, IQuery<T3> c3, IQuery<T4> c4, IQuery<T5> c5, IQuery<T6> c6, IQuery<T7> c7, Func<T1, T2, T3, T4, T5, T6, T7, TQuery> mapping)
    {
        int resultIndex = _queries.Count;
        ...
        _queries.AddRange(c7.GetQueries());
    ...
    public IQueryBuilder<TQuery> AddQuery<T1, T2, T3, T4, T5, T6, T7, T8>(IQuery<T1> c1, IQuery<T2> c2, IQuery<T3> c3, IQuery<T4> c4, IQuery<T5> c5, IQuery<T6> c6, IQuery<T7> c7, IQuery<T8> c8, Func<T1, T2, T3, T4, T5, T6, T7, T8, TQuery> mapping)
    {
        int resultIndex = _queries.Count;
        ...
        _queries.AddRange(c8.GetQueries());
    ...
    public IQueryBuilder<TQuery> AddQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9>(IQuery<T1> c1, IQuery<T2> c2, IQuery<T3> c3, IQuery<T4> c4, IQuery<T5> c5, IQuery<T6> c6, IQuery<T7> c7, IQuery<T8> c8, IQuery<T9> c9, Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TQuery> mapping)
    {
        int resultIndex = _queries.Count;
        ...
        _queries.AddRange(c9.GetQueries());
