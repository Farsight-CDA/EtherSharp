...
internal class GetCompatibilityQueryOperation : IQuery<CompatibilityReport>
{
    ...
    private static readonly IContractDeployment _blobBaseFee = IContractDeployment.Create(new EVMByteCode(Convert.FromHexString("600b380380600b3d393df34a")), 0);
    ...
    private static readonly IQuery[] _queries = [
        ...
        new SafeFlashCallQueryOperation<bool>(_blobBaseFee, _call),
