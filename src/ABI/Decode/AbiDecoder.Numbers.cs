...
public partial class AbiDecoder
{
    ...
    {
        value = FixedType<object>.Long.Decode(Bytes);
        return ConsumeBytes(0);
    }
    public AbiDecoder UInt40(out ulong value)
    {
        value = FixedType<object>.ULong.Decode(Bytes);
        return ConsumeBytes(0);
    }
    ...
    {
        value = FixedType<object>.BigInteger.Decode(Bytes, false);
        return ConsumeBytes(0);
    }
    public AbiDecoder UInt72(out BigInteger value)
    {
        value = FixedType<object>.BigInteger.Decode(Bytes, true);
        return ConsumeBytes(0);
    }
